/*! Editor.md v1.4.1 | editormd.min.js | Open source online markdown editor. | MIT License | By: Pandao | https://github.com/pandao/editor.md | 2015-04-07 */
!function (e) {
    "use strict";
    ...
    if ("undefined" != typeof e) {
        ...
        t.title = t.$name = "Editor.md", t.version = "1.4.1", t.homePage = "https://pandao.github.io/editor.md/", t.classPrefix = "editormd-", t.toolbarModes = {
        ...
        t.prototype = t.fn = {
            state: {watching: !1, loaded: !1, preview: !1, fullscreen: !1}, init: function (i, o) {
                ...
                l.length < 1 && (a.append("<textarea></textarea>"), l = this.markdownTextarea = a.children("textarea")), l.addClass(s.textarea.markdown).attr("name", i + "-markdown-doc").attr("placeholder", n.placeholder);
                ...
                var i = this.settings;
                return i.theme = e, "default" !== e && t.loadCSS(i.path + "codemirror/theme/" + i.theme), this.cm.setOption("theme", e), this
            }, setCodeMirror: function () {
                var e = this.settings, i = this.editor;
                "default" !== e.theme && t.loadCSS(e.path + "codemirror/theme/" + e.theme);
                var o = {
                    mode: e.mode,
                    theme: e.theme,
                    tabSize: 4,
                ...
                }), e.autoHeight && (this.codeMirror.css("height", "auto"), this.cm.setOption("viewportMargin", 1 / 0)), this
                ...
                r.show();
                for (var a = "function" == typeof e.toolbarIcons ? e.toolbarIcons() : "string" == typeof e.toolbarIcons ? t.toolbarModes[e.toolbarIcons] : e.toolbarIcons, s = r.find("." + this.classPrefix + "menu"), l = "", c = 0, h = a.length; h > c; c++) {
                    var d = a[c];
                    if ("|" !== d) {
                        var u = /h(\d)/.test(d), f = d;
                        "watch" !== d || e.watch || (f = "unwatch");
                        var g = e.lang.toolbar[f], p = e.toolbarIconTexts[f], m = e.toolbarIconsClass[f];
                        g = "undefined" == typeof g ? "" : g, p = "undefined" == typeof p ? "" : p, m = "undefined" == typeof m ? "" : m, l += "<li>", l += "undefined" != typeof e.toolbarCustomIcons[d] && "function" != typeof e.toolbarCustomIcons[d] ? e.toolbarCustomIcons[d] : '<a href="javascript:;" title="' + g + '" unselectable="on"><i class="fa ' + m + '" name="' + d + '" unselectable="on">' + (u ? d.toUpperCase() : "" === m ? p : "") + "</i></a>", l += "</li>"
                    } else l += '<li class="divider" unselectable="on">|</li>'
                }
                ...
                return s.bind(t.mouseOrTouch("click", "touchend"), function () {
                    var t = e(this).children(".fa"), r = t.attr("name"), a = n.getCursor(), s = n.getSelection();
                    return "" !== r ? (i.activeIcon = t, "undefined" != typeof l[r] ? e.proxy(l[r], i)(n) : "undefined" != typeof o.toolbarHandlers[r] && e.proxy(o.toolbarHandlers[r], i)(n, t, a, s), "link" !== r && "reference-link" !== r && "image" !== r && "code-block" !== r && "preformatted-text" !== r && "watch" !== r && "preview" !== r && "search" !== r && "fullscreen" !== r && "info" !== r && n.focus(), !1) : void 0
                }), this
                ...
                var e = this.settings, i = this.previewContainer;
                if (t.isIE8)return this;
                if (e.flowChart) {
                    if (null === o)return this;
                    i.find(".flowchart").flowChart()
                }
                return e.sequenceDiagram && i.find(".sequence-diagram").sequenceDiagram({theme: "simple"}), this
                ...
                var s = function () {
                    n.find(".CodeMirror-scroll").bind(a("scroll", "touchmove"), function (t) {
                        var n = e(this).height(), a = e(this).scrollTop(), s = a / e(this)[0].scrollHeight;
                        o.scrollTop(0 === a ? 0 : a + n >= e(this)[0].scrollHeight - 16 ? o[0].scrollHeight : o[0].scrollHeight * s), e.proxy(r.onscroll, i)(t)
                    })
                }, l = function () {
                ...
                return n.bind({mouseover: s, mouseout: l, touchstart: s, touchend: l}), o.bind({
                    mouseover: c,
                    mouseout: h,
                    touchstart: c,
                    touchend: h
                ...
                return o.syncScrolling ? (t.on("change", function () {
                ...
                return t && r.css("width", "number" == typeof t ? t + "px" : t), !s.autoHeight || o.fullscreen || o.preview ? (i && r.css("height", "number" == typeof i ? i + "px" : i), o.fullscreen && r.height(e(window).height()), s.toolbar && !s.readOnly ? l.css("margin-top", a.height() + 1).height(r.height() - a.height()) : l.css("margin-top", 0).height(r.height())) : (r.css("height", "auto"), l.css("height", "auto")), s.watch ? (l.width(r.width() / 2), n.width(o.preview ? r.width() : r.width() / 2), this.previewContainer.css("padding", s.autoHeight ? "20px 20px 50px 40px" : "20px"), s.toolbar && !s.readOnly ? n.css("top", a.height()) : n.css("top", 0), n.height(!s.autoHeight || o.fullscreen || o.preview ? s.toolbar && !s.readOnly ? r.height() - a.height() : r.height() : "")) : (l.width(r.width()), n.hide()), o.loaded && e.proxy(s.onresize, this)(), this
            }, save: function () {
                ...
                h.setOptions(f), l = t.filterHTMLTags(l, a.htmlDecode);
                var g = t.$marked(l, f);
                if (this.markdownTextarea.val(l), s.save(), a.saveHTMLToTextarea && this.htmlTextarea.val(g), a.watch || !a.watch && n.preview) {
                ...
                return this.settings.saveHTMLToTextarea ? this.htmlTextarea.html() : (alert("Error: settings.saveHTMLToTextarea == false"), !1)
                ...
                var i = this, o = this.editor, r = this.preview, n = this.toolbar, a = this.settings, s = this.codeMirror;
                ...
                "none" === s.css("display") ? (this.state.preview = !0, this.state.fullscreen && r.css("background", "#fff"), o.find("." + this.classPrefix + "preview-close-btn").show().bind(t.mouseOrTouch("click", "touchend"), function () {
                    i.previewed()
                }), a.watch || this.save(), r.show().css({
                    position: "static",
                    top: 0,
                    width: o.width(),
                    height: a.autoHeight && !this.state.fullscreen ? "auto" : o.height()
                }), this.state.loaded && e.proxy(a.onpreviewing, this)(), e(window).bind("keyup", l)) : (e(window).unbind("keyup", l), this.previewed())
            }, previewed: function () {
                var i = this.editor, o = this.preview, r = this.toolbar, n = this.settings, a = i.find("." + this.classPrefix + "preview-close-btn");
                return this.state.preview = !1, this.codeMirror.show(), n.toolbar && r.show(), o[n.watch ? "show" : "hide"](), a.hide().unbind(t.mouseOrTouch("click", "touchend")), o.css({
                    background: null,
                    position: "absolute",
                    width: i.width() / 2,
            ...
            undo: function () {
                ...
                var e = this.cm, t = e.getCursor(), i = e.getSelection();
                e.replaceSelection("> " + i), e.setCursor(t.line, "" === i ? t.ch + 2 : t.ch + i.length + 2)
            }, ucfirst: function () {
        ...
        return t.firstUpperCase = t.ucfirst = a, t.urls = {atLinkBase: "https://github.com/"}, t.regexs = {
            ...
            return l.emoji = function (e) {
                ...
                for (var o = 0, r = i.length; r > o; o++)e = e.replace(new RegExp(i[o]), function (e) {
                    var i = e.match(p), o = e.replace(/:/g, "");
                    if (i)for (var r = 0, n = i.length; n > r; r++) {
                        var a = i[r].replace(/:/g, "");
                        return '<i class="fa ' + a + ' fa-emoji" title="' + a.replace("fa-", "") + '"></i>'
                    } else {
                        var s = e.match(m), l = e.match(g);
                        if (s)for (var c = 0, h = s.length; h > c; c++) {
                            var d = s[c].replace(/:/g, "");
                            return '<i class="' + d + '" title="Editor.md logo (' + d + ')"></i>'
                        } else {
                            if (!l)return '<img src="' + t.emoji.path + o + t.emoji.ext + '" class="emoji" title="&#58;' + o + '&#58;" alt="&#58;' + o + '&#58;" />';
                            for (var u = 0, f = l.length; f > u; u++) {
                                var w = l[u].replace(/:/g, "").replace("tw-", "");
                                return '<img src="' + t.twemoji.path + w + t.twemoji.ext + '" title="twemoji-' + w + '" alt="twemoji-' + w + '" class="emoji twemoji" />'
                            }
                        }
                    }
                });
                ...
                return h.test(i) ? (a.atLink && (i = i.replace(u, function (e) {
            ...
            }, l.heading = function (e, t) {
                var o = e, n = /\s*\<a\s*href\=\"(.*)\"\s*([^\>]*)\>(.*)\<\/a\>\s*/;
                if (n.test(e)) {
                    var a = [];
                    e = e.split(/\<a\s*([^\>]+)\>([^\>]*)\<\/a\>/);
                    for (var s = 0, l = e.length; l > s; s++)a.push(e[s].replace(/\s*href\=\"(.*)\"\s*/g, ""));
                    e = a.join(" ")
                }
                e = r(e);
                var c = e.toLowerCase().replace(/[^\w]+/g, "-"), h = {
                    text: e,
                    level: t,
                    slug: c
                }, d = /^[\u4e00-\u9fa5]+$/.test(e), u = d ? escape(e).replace(/\%/g, "") : e.toLowerCase().replace(/[^\w]+/g, "-");
                i.push(h);
                var f = "<h" + t + ' id="h' + t + "-" + this.options.headerPrefix + u + '">';
                return f += '<a name="' + e + '" class="reference-link"></a>', f += '<span class="header-link octicon octicon-link"></span>', f += this.atLink(n ? this.emoji(o) : this.emoji(e)), f += "</h" + t + ">"
                ...
                return "seq" === t || "sequence" === t ? '<div class="sequence-diagram">' + e + "</div>" : "flow" === t ? '<div class="flowchart">' + e + "</div>" : s.Renderer.prototype.code.apply(this, arguments)
        ...
        }, t.filterHTMLTags = function (e, t) {
            if ("string" == typeof t)for (var i = t.split(","), o = 0, r = i.length; r > o; o++) {
                var n = i[o];
                e = e.replace(new RegExp("<s*" + n + "s*([^>]*)>", "igm"), "").replace(new RegExp("<s*/" + n + "s*>", "igm"), "")
            }
            return e
            ...
            l = t.filterHTMLTags(l, a.htmlDecode);
            var u = marked(l, d);
            if (s.val(l), n.addClass("markdown-body " + this.classPrefix + "html-preview").append(u), a.toc && (n.tocContainer = this.markdownToCRenderer(c, n, a.tocDropdown, a.tocStartLevel), (a.tocDropdown || n.find("." + this.classPrefix + "toc-menu").length > 0) && this.tocDropdownMenu(n, a.tocTitle)), a.previewCodeHighlight && (n.find("pre").addClass("prettyprint linenums"), prettyPrint()), t.isIE8 || (a.flowChart && n.find(".flowchart").flowChart(), a.sequenceDiagram && n.find(".sequence-diagram").sequenceDiagram({theme: "simple"})), a.tex) {
                var f = function () {
                    n.find("." + t.classNames.tex).each(function () {
                        var t = e(this);
                        katex.render(t.html(), t[0])
                    })
                };
                !a.autoLoadKaTeX || t.$katex || t.kaTeXLoaded ? f() : this.loadKaTeX(function () {
                    t.$katex = katex, t.kaTeXLoaded = !0, f()
                })
            }
            return n.getMarkdown = function () {
                return s.val()
            }, n
        }, t.themes = ["default", "3024-day", "3024-night", "ambiance", "ambiance-mobile", "base16-dark", "base16-light", "blackboard", "cobalt", "eclipse", "elegant", "erlang-dark", "lesser-dark", "mbo", "mdn-like", "midnight", "monokai", "neat", "neo", "night", "paraiso-dark", "paraiso-light", "pastel-on-dark", "rubyblue", "solarized", "the-matrix", "tomorrow-night-eighties", "twilight", "vibrant-ink", "xq-dark", "xq-light"], t.loadPlugins = {}, t.loadFiles = {
            js: [],
            css: [],
            plugin: []
            ...
            i = e.extend(!0, o, i);
            var r = this.editor, n = t.classPrefix, a = (new Date).getTime(), s = "" === i.name ? n + "dialog-" + a : i.name, l = t.mouseOrTouch, c = '<div class="' + n + "dialog " + s + '">';
            "" !== i.title && (c += '<div class="' + n + 'dialog-header"' + (i.drag ? ' style="cursor: move;"' : "") + ">", c += '<strong class="' + n + 'dialog-title">' + i.title + "</strong>", c += "</div>"), i.closed && (c += '<a href="javascript:;" class="fa fa-close ' + n + 'dialog-close"></a>'), c += '<div class="' + n + 'dialog-container">' + i.content, (i.footer || "string" == typeof i.footer) && (c += '<div class="' + n + 'dialog-footer">' + ("boolean" == typeof i.footer ? "" : i.footer) + "</div>"), c += "</div>", c += '<div class="' + n + "dialog-mask " + n + 'dialog-mask-bg"></div>', c += '<div class="' + n + "dialog-mask " + n + 'dialog-mask-con"></div>', c += "</div>", r.append(c);
            var h = r.find("." + s);
            h.lockScreen = function (t) {
                return i.lockScreen && e("html,body").css("overflow", t ? "hidden" : ""), h
            }, h.showMask = function () {
                return i.mask && r.find("." + n + "mask").css(i.maskStyle).css("z-index", t.dialogZindex - 1).show(), h
            }, h.hideMask = function () {
                return i.mask && r.find("." + n + "mask").hide(), h
            }, h.loading = function (e) {
                var t = h.find("." + n + "dialog-mask");
                return t[e ? "show" : "hide"](), h
            ...
            if (d(), e(window).resize(d), h.children("." + n + "dialog-close").bind(l("click", "touchend"), function () {
                    h.hide().lockScreen(!1).hideMask()
                }), "object" == typeof i.buttons) {
                var u = h.footer = h.find("." + n + "dialog-footer");
                for (var f in i.buttons) {
                    var g = i.buttons[f], p = n + f + "-btn";
                    u.append('<button class="' + n + "btn " + p + '">' + g[0] + "</button>"), g[1] = e.proxy(g[1], h), u.children("." + p).bind(l("click", "touchend"), g[1])
                }
            }
            if ("" !== i.title && i.drag) {
                var m, w, v = h.children("." + n + "dialog-header");
                i.mask || v.bind(l("click", "touchend"), function () {
                    t.dialogZindex += 2, h.css("z-index", t.dialogZindex)
                }), v.mousedown(function (e) {
                    e = e || window.event, m = e.clientX - parseInt(h[0].style.left), w = e.clientY - parseInt(h[0].style.top), document.onmousemove = x
                });
                var k = function (e) {
                    e.removeClass(n + "user-unselect").off("selectstart")
                }, b = function (e) {
                    e.addClass(n + "user-unselect").on("selectstart", function () {
                        return !1
                    })
                }, x = function (t) {
                    t = t || window.event;
                    var i, o, r = parseInt(h[0].style.left), n = parseInt(h[0].style.top);
                    r >= 0 ? r + h.width() <= e(window).width() ? i = t.clientX - m : (i = e(window).width() - h.width(), document.onmousemove = null) : (i = 0, document.onmousemove = null), n >= 0 ? o = t.clientY - w : (o = 0, document.onmousemove = null), document.onselectstart = function () {
                        return !1
